...
test("render ToolbarButtonIcon", async () => {
  ...
  expect(pretty(container.innerHTML)).toMatchInlineSnapshot(`
    "<li class=\\"nav-item\\">
      <div class=\\"nav-link\\" to=\\"#\\" role=\\"button\\"></div>
    </li>"
  `);
});
...
test("render ToolbarButtonChartMetric", async () => {
  ...
  expect(pretty(container.innerHTML)).toMatchInlineSnapshot(`
    "<li class=\\"nav-item\\">
      <div class=\\"nav-link active\\" role=\\"button\\">Kwh <span class=\\"badge bg-secondary text-white\\">0</span></div>
    </li>"
  `);
});
  ...
  expect(pretty(container.innerHTML)).toMatchInlineSnapshot(`
    "<div class=\\"pt-3 pb-2 mb-3 border-bottom\\">
      <ul class=\\"nav nav-pills justify-content-center\\">
        ...
        <li class=\\"nav-item\\">
          <div class=\\"nav-link\\" role=\\"button\\">Duration <span class=\\"badge bg-secondary text-white\\">0</span></div>
        </li>
        <li class=\\"nav-item\\">
          <div class=\\"nav-link\\" to=\\"#\\" role=\\"button\\"><svg width=\\"24\\" height=\\"24\\" fill=\\"currentColor\\" class=\\"bi bi-arrow-clockwise\\" viewBox=\\"0 0 16 16\\">
              <path fill-rule=\\"evenodd\\" d=\\"M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2v1z\\"></path>
              <path d=\\"M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z\\"></path>
            </svg></div>
        </li>
        <li class=\\"nav-item\\">
          <div class=\\"nav-link\\" to=\\"#\\" role=\\"button\\"><svg width=\\"24\\" height=\\"24\\" fill=\\"currentColor\\" class=\\"bi bi-gear\\" viewBox=\\"0 0 16 16\\">
