...
namespace BackendTests
{
    public class SensorLogBatchBackgroundServiceTests : AppDbContextMock
    {
        ...
        public async Task ExecuteAsyncTestAsync()
        {
            ...
            var recentEneryLogsSensor_01 = this.DbContext.GetSensorEnergyLogsRecent(sensor_01);
            var recentEneryLogsSensor_02 = this.DbContext.GetSensorEnergyLogsRecent(sensor_02);
            ...
            recentEneryLogsSensor_01 = this.DbContext.GetSensorEnergyLogsRecent(sensor_01);
            recentEneryLogsSensor_02 = this.DbContext.GetSensorEnergyLogsRecent(sensor_02);
